...
const page = () => {
    ...
    const { user, loading, error, name, setName, email, setEmail, password, setPassword, handleEmailAccountCreation, handlesignInWithGoogle, handlesignInWithGithub, handleLogout } = useAuth();
